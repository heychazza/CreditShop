package io.felux.credits;

import dev.chapi.api.exception.InvalidMaterialException;
import dev.chapi.api.item.ItemBuilder;
import io.felux.credits.command.util.CommandExecutor;
import io.felux.credits.command.util.CommandManager;
import io.felux.credits.hook.PlaceholderAPIHook;
import io.felux.credits.listener.JoinListener;
import io.felux.credits.maven.LibraryLoader;
import io.felux.credits.maven.MavenLibrary;
import io.felux.credits.maven.Repository;
import io.felux.credits.shop.ShopItem;
import io.felux.credits.shop.ShopManager;
import io.felux.credits.storage.PlayerData;
import io.felux.credits.storage.StorageHandler;
import io.felux.credits.storage.mongodb.MongoDBHandler;
import io.felux.credits.storage.mysql.MySQLHandler;
import io.felux.credits.storage.sqlite.SQLiteHandler;
import io.felux.credits.util.Common;
import io.felux.credits.util.ConsoleFilter;
